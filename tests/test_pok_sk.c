...
void test_pok_sk() {
    ...
    unsigned char proof[65]; // Schnorr proof is 64 bytes + 1 byte header usually, or just 64 depending on impl.
    ...
    // Proof should bind to the specific context_id. Changing it should fail verification.
