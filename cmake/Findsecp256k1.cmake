...
find_path(secp256k1_INCLUDE_DIR secp256k1.h HINTS ${secp256k1_DIR} PATH_SUFFIXES include)

find_library(secp256k1_LIBRARY NAMES secp256k1 HINTS ${secp256k1_DIR} PATH_SUFFIXES lib)
...
if (secp256k1_FOUND AND NOT TARGET secp256k1::secp256k1)
    ...
    set_target_properties(secp256k1::secp256k1 PROPERTIES IMPORTED_LOCATION "${secp256k1_LIBRARY}"
